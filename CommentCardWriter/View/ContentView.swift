    ...
    var body: some View {
        NavigationView {
            Form {
                ...
                GenerationFormItem(message: "How has your performance been this half?", ratings:  ["1", "2", "3", "4", "5"], toChange: updateEnjoyment)
                GenerationFormItem(message: "How good has your teacher been this half?", ratings: ["1", "2", "3", "4", "5"], toChange: updateEnjoyment)
